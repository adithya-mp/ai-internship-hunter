...
export default function SignUp() {
  ...
  const { register, oauthLogin, isLoading, error } = useAuthStore();
    ...
    <div className="min-h-screen bg-dark-bg flex flex-col justify-center py-12 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md relative z-10 text-center">
        ...
        <p className="mt-2 text-center text-sm text-slate-400">
          Get started with AI-driven internship matching
        </p>
      </div>
            ...
            {oauthStep === 'select' && (
              <div className="space-y-4">
                <div>
                  ...
                  <p className="text-sm text-slate-400 mt-0.5">Choose a mock profile to sign up to <span className="text-primary-400 font-semibold">ApplyIQ</span></p>
                </div>
